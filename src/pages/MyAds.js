...
import { fetchAds, deleteAd, parseAdsData } from "../api/adsApi";
...
function MyAds() {
  ...
  const navigateToCreateAd = () => {
    if (currentUser?.user_type === "شركة مزادات") {
      navigate("/create-auction"); // إذا كان شركة مزادات، اذهب لمزادات
    } else {
      navigate("/create-ad"); // باقي المستخدمين يذهبون لإنشاء إعلان
    }
  };
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full">
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-6">
                هل أنت متأكد من حذف{" "}
                <span className="font-medium">{confirmDelete.adTitle}</span>؟
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <p className="text-gray-600 text-sm">
            عرض {filteredAds.length}{" "}
            {currentUser?.user_type === "شركة مزادات" ? "مزاد" : "إعلان"}
        ...
        {error ? (
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              {error.message || "فشل في جلب الإعلانات"}
            </p>
            <button
              onClick={() => refetch()}
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      e.target.src =
                        "https://via.placeholder.com/300x150/f8f9fa/6c757d?text=لا+توجد+صورة";
                    }}
                  />
                ...
                <div className="p-6">
                        ...
                        {ad.total_area && (
                          <div className="flex justify-between text-sm text-gray-600">
                            ...
                            <span className="font-medium">
                              {parseFloat(ad.total_area).toLocaleString(
                                "ar-SA"
                              )}{" "}
                              م²
                            </span>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    <div className="flex gap-2">
                      ...
                      >
                        {deleteMutation.isLoading &&
                        deleteMutation.variables?.adId === ad.id ? (
                          <Icons.FaSpinner className="w-4 h-4 animate-spin" />
                        ) : (
                          <Icons.FaTrash className="w-4 h-4" />
                        )}
