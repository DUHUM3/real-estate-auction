  ...
  const handleApiError = (err) => {
    if (err.response) {
      if (err.response.status === 401) {
        ...
        const errorMsg =
          "عذراً، ليس لديك صلاحية لإنشاء طلبات تسويق منتجات عقارية";
        showApiError(errorMsg);
        setError(errorMsg);
      } else {
          ...
          <div className="bg-white rounded-xl shadow-md overflow-hidden">
            <div className="p-8 md:p-12 text-center">
              ...
              <p className="text-gray-600 mb-8 max-w-md mx-auto">
                عذراً، شركات المزادات غير مسموح لها بإنشاء طلبات تسويق منتجات
                عقارية.
                <br />
              ...
              {responseData && (
                <div className="bg-gray-50 rounded-lg p-6 mb-8 max-w-2xl mx-auto text-right">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <strong className="text-gray-500 text-sm block mb-1">
                        رقم الطلب:
                      </strong>
