...
function Home({ onLoginClick }) {
  ...
  <title>شاهين بلس | الرئيسية</title>
  
  {/* الوصف التفصيلي - جذاب وغني بالكلمات المفتاحية */}
  <meta
    name="description"
    content="منصة شاهين بلس الرائدة في السعودية تتيح لك عرض وشراء وبيع الأراضي والمزادات العقارية بأمان وسهولة. تصفح  العقارات، واستثمر في أفضل الفرص العقارية مع ضمان المعاملات الآمنة والشفافة."
  />
