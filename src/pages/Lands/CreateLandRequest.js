...
function CreateLandRequest() {
  ...
  const checkUserType = () => {
    try {
      ...
      if (storedUserType === 'شركة مزادات') {
        ...
        showApiError('عذراً، شركات المزادات غير مسموح لها بإنشاء طلبات تسويق أراضي');
      } else {
  ...
  const isFormValid = isUserAllowed() && formData.region && formData.city && formData.area && 
        ...
        <header className="bg-white border-b border-gray-200 sticky top-0 z-50 shadow-sm">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div className="flex items-center justify-between">
              ...
              <h1 className="text-xl font-bold text-gray-800 text-center">طلب تسويق أرض</h1>
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          {loading ? (
            <div className="flex flex-col items-center justify-center py-16">
              <div className="w-16 h-16 border-4 border-blue-100 border-t-[#53a1dd] rounded-full animate-spin mb-4"></div>
              <p className="text-gray-600 text-lg">جاري إنشاء طلب الأرض...</p>
            </div>
          ) : success ? (
            <div className="p-8 md:p-12 text-center">
              ...
              {responseData && (
                <div className="bg-gray-50 rounded-lg p-6 mb-8 max-w-2xl mx-auto text-right">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <strong className="text-gray-500 text-sm block mb-1">الغرض:</strong>
                      <span className="text-gray-800 font-medium">
                        {formData.purpose === 'sale' ? 'بيع' : formData.purpose === 'investment' ? 'استثمار' : formData.purpose}
                      </span>
                    </div>
                    <div>
                      <strong className="text-gray-500 text-sm block mb-1">نوع الأرض:</strong>
                      <span className="text-gray-800 font-medium">
                    ...
                    <div>
                      <strong className="text-gray-500 text-sm block mb-1">المساحة:</strong>
                      <span className="text-gray-800 font-medium">{formData.area} م²</span>
                    </div>
                    <div>
            ...
            <div>
              <div className="p-8">
                <div className="text-center mb-8">
                  <h1 className="text-2xl font-bold text-gray-800 mb-2">طلب تسويق أرض</h1>
                  <p className="text-gray-600">املأ النموذج أدناه لإنشاء طلب تسويق أرض جديد</p>
                </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-sm">حدد موقع الأرض الجغرافي</p>
                        </div>
                      </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-sm">أدخل التفاصيل الفنية للأرض</p>
                        </div>
                      </div>
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                      <div className="flex items-center gap-3 mb-6">
                        ...
                        <div>
                          ...
                          <p className="text-gray-500 text-sm">أدخل وصفاً مفصلاً للأرض ومميزاتها</p>
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="text-gray-500 text-sm mt-2">
                          أدخل وصفاً تفصيلياً للأرض لزيادة فرص التسويق الناجح.
                        </p>
                      </div>
                    </div>
                      ...
                      <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-500 text-sm">قم برفع صور للأرض</p>
                          </div>
                        </div>
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <label className="text-gray-700 block mb-2">
                            أوافق على <a href="#" className="text-[#53a1dd] hover:text-[#478bc5] font-medium underline">الشروط والأحكام</a> الخاصة بتسويق الأراضي
                          </label>
                          <p className="text-gray-500 text-sm">
